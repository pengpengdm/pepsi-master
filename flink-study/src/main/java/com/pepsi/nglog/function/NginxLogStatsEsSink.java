 ...
 * Description: es sink
 */
public class NginxLogStatsEsSink extends RichSinkFunction<RichNginxLog> {

    private static final long serialVersionUID = 1L;

    private static final Logger LOGGER = LoggerFactory.getLogger(NginxLogStatsEsSink.class);
